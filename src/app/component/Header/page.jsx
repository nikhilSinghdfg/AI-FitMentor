            ...
            {isDropdownOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-lg z-20">
                <ul className="space-y-2 p-2">
                  <li><button onClick={logout} className="w-full text-left hover:bg-blue-700 hover:text-white p-2 rounded">Logout</button></li>
                  <li><button onClick={verifyEmail} className="w-full text-left hover:bg-blue-700 hover:text-white p-2 rounded">Verify Email</button></li>
                  <li><button onClick={getUserData} className="w-full text-left hover:bg-blue-700 hover:text-white p-2 rounded">User</button></li>
                </ul>
              </div>
            )}
          </div>
